        ...
        @forelse ($users as $user)
            <div class="col-md-6 col-lg-3">
                <div class="card user-card">
                    ...
                    <div class="d-flex">
                        <a href="#"
                            class="card-btn text-primary"><!-- Download SVG icon from http://tabler.io/icons/icon/mail -->
                            <x-icon name="edit" />
                            <span class="mx-1"> {{ __('titles.show') }}/{{ __('titles.edit') }}</span>
                        </a>
                        <a href="#"
                            class="card-btn text-red"><!-- Download SVG icon from http://tabler.io/icons/icon/phone -->
                            <x-icon name="trash" />
