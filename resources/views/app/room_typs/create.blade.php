                ...
                <div class="row g-3">
                    <div class="col-lg-4">
                        ...
                        <input type="text" id="roomtype_name" name="name" class="form-control"
                            value="{{ old('roomtype_name') }}" placeholder="{{ __('roomtype.name') }}" autofocus>
                        @error('name')
                    ...
                    <div class="col-lg-4">
                        ...
                        <input type="text" id="roomtype_size" name="size" class="form-control"
                            value="{{ old('roomtype_size') }}" placeholder="{{ __('roomtype.size') }}">
                        @error('size')
                            <div class="text-red mt-1">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-lg-12">
                        ...
                        <textarea name="description" class="form-control" id="roomtype_description"
                            placeholder="{{ __('roomtype.description') }}">{{ old('roomtype_description') }}</textarea>
                    </div>
                </div>
            </div>
