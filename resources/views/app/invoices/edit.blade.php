            ...
            <form method="POST" action="{{ route('invoice.update', $invoice['id'] ?? '') }}">
                ...
                <div class="card-body">
                    ...
                    <div class="row g-3">
                        @php
                            ...
                            $fields = ['month', 'old_electric', 'new_electric', 'electric_rate', 'old_water', 'new_water', 'water_rate', 'other_charge'];
                        @endphp
                ...
                <div class="card-footer d-flex align-items-center justify-content-end">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <a href="{{ route('invoice.user_index') }}" class="btn btn-secondary">
                            {{ __('invoice.cancel') }}
                        </a>
                    </div>
                </div>
