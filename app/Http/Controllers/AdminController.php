...
class AdminController extends Controller
{
    public function index(Request $request)
    {
        ...
        foreach ($locations as $location) {
            ...
            foreach ($rooms as $room) {
                ...
                foreach ($roomClients as $client) {
                    ...
                    $isActiveClient = (string) ($client['status'] ?? '') === '1';
        ...
        $monthlyInvoiceTotal = $upcomingInvoiceTenants
            ->sum(
                fn($tenant) => is_numeric($tenant['invoice_price'] ?? null)
    ...
    private function decorateClient(array $client, array $room, string $locationName): array
    {
        ...
        $clientImageUrl = api_image($clientImagePath);
    ...
    private function dashboardCards(
        ...
        $cards[] = [
            ...
            'subtext' => __('Next month reminder'),
        ];
